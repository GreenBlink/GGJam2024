...
public class GameService : MonoBehaviour
{
    ...
    {
        _currentMove++;
        Debug.Log(_currentMove +": Номер хода");
    ...
    private void ChoiceCard(CardData data)
    {
        ...
        Debug.Log(data.Name + " Имя сыгранной карты");
        Debug.Log(data.Secta + "+ Изменение в секте");
        Debug.Log(data.Points + " Изменение в поинтах");
        Debug.Log(data.Inquisition + " Изменение в инквизиции");
    }
}
